    ...
    <section className="py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden border border-rule/6 bg-panel-alt p-8 h-80">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="text-5xl font-black text-brand-500 mb-1">5+</div>
                  <div className="text-sm text-ink/35">Years building</div>
                  <div className="text-5xl font-black text-brand-500 mt-4 mb-1">3</div>
                  <div className="text-sm text-ink/35">Continents served</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-ink/45 leading-relaxed mb-5">
            ...
            <p className="text-ink/45 leading-relaxed">
              The name Strixora comes from <em className="text-ink/70">Strix</em> — the
