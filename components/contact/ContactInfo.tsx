...
export function ContactInfo() {
  return (
    <div className="space-y-6">
      {/* Contact details */}
      <div className="rounded-3xl border border-white/6 bg-[#0f0f1a] p-7">
        <h3 className="text-sm font-semibold text-white mb-5">Contact details</h3>
        ...
        <div className="mt-6 pt-6 border-t border-white/6 space-y-3">
          <a
            ...
            className={cn(
              ...
              "text-sm text-brand-400 font-medium transition-all duration-200"
            )}
          >
          ...
          <a
            ...
            className={cn(
              ...
              "text-sm text-gray-400 hover:text-white font-medium transition-all duration-200"
            )}
          >
        ...
        <div className="space-y-4">
          {faqs.map((faq) => (
            <div key={faq.q} className="border-b border-white/5 pb-4 last:border-0 last:pb-0">
              <p className="text-sm font-medium text-gray-300 mb-1.5">{faq.q}</p>
